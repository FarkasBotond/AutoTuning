      ...
      <section class="flex-1">
        ...
        >
          ...
          <p class="mt-3 text-zinc-600">
            A termek adatai betoltes alatt vannak.
          </p>
        </div>
          ...
          <div class="glass-panel p-5 md:p-6">
            <div class="grid gap-6 lg:grid-cols-[480px_1fr]">
              <div class="overflow-hidden rounded-2xl border border-zinc-200 bg-white">
                ...
                <div
                  v-else
                  class="flex min-h-[360px] items-center justify-center text-sm font-semibold text-zinc-400"
                >
                  Nincs kep
                </div>
              </div>
        ...
        <div v-else class="glass-panel p-10 text-center">
          <h2 class="text-3xl font-bold text-zinc-900">
            A termek nem talalhato
          </h2>

          <p class="mt-3 text-zinc-600">
            Ellenorizd a linket vagy valassz masik termeket.
          </p>
