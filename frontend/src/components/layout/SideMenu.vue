...
const handleBrandClick = (brand) => {
    openedBrandId.value = openedBrandId.value === brand.id ? null : brand.id
        ...
        <div class="max-h-[720px] overflow-y-auto p-3">
            <div v-if="activeTab === 'categories'" class="space-y-3">
                ...
                >
                    ...
                    <div
                        class="absolute inset-y-0 left-0 w-1 rounded-l-xl bg-teal-600 transition"
                        :class="selectedCategoryId === item.id ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'"
                    ></div>

                    <span
                        class="relative z-10 pr-3 text-base font-bold leading-tight text-zinc-800 md:text-lg"
                ...
                <template v-else>
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                class="text-lg leading-none text-zinc-400 transition duration-200"
                        ...
                        <Transition name="model-drop">
                            <div
                                v-if="openedBrandId === brand.id"
                                class="ml-5 space-y-2 overflow-hidden"
                            >
                                <button
                                    v-for="model in getModelsByBrandId(brand.id)"
                                    :key="model.id"
                                    type="button"
                                ...
                                <div
                                    v-if="getModelsByBrandId(brand.id).length === 0"
