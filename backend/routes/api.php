...
Route::get('/tuning-products', [TuningProductController::class, 'index'])
    ->name('tuning-products.index');

Route::get('/tuning-products/{tuningProduct}', [TuningProductController::class, 'show'])
    ->name('tuning-products.show')
    ->whereNumber('tuningProduct');

Route::get('/tuning-companies', [TuningCompanyController::class, 'index'])
    ->name('tuning-companies.index');

Route::get('/tuning-companies/{tuningCompany}', [TuningCompanyController::class, 'show'])
    ->name('tuning-companies.show')
    ->whereNumber('tuningCompany');

Route::get('/service-categories', [ServiceCategoryController::class, 'index'])
    ->name('service-categories.index');

// Public order route - vendégként is működik
